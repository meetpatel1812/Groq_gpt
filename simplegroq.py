...
st.set_page_config(page_icon="💬", page_title="Simple Chat GPT by Meet Patel")
...
st.subheader("🅜 Simple Chat GPT by Meet",divider="red", anchor=False)
...
system_message = {
    "role": "system",
    "content": "You are Chat GPT, give answer based on User input."
}
